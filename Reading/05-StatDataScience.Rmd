...
8.1 A company’s 5 levels of analytical maturity
...
8.3 Data science team

It is an article for data science in startups but we can still learn some general points.

What can data science do?
Improving the products： -Rely on a virtuous cycle where products collect usage data that becomes the fodder for algorithms which in turn offer users a better experience.
